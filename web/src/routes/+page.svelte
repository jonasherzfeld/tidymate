...
<div class="flex min-h-full w-full justify-center bg-base-100">
  ...
  {#if showModal}
    <div class="modal modal-open">
      <div class="modal-box">
        <h3 class="text-lg font-bold">Registration Information</h3>
        <div class="text-md text-justify">
          This web app is a hobby project that I started to learn more about
          Full Stack development and dive into some technologies that I had not
          used before like
        </div>
        ...
        <div class="text-md text-justify">
          While the intention is that this project is a fully functional web
          app, I have currently
          <b class="font-semibold">restricted the registration of new users</b> to
          run this as a purely personal website for me and my family and by that
