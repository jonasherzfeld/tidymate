...
export const actions: Actions = {
  view_notification: async ({ request, cookies }) => {
    ...
    const res = await fetch(`${BASE_API_URI}/notifications/view-notification/${id}`, {
      method: "PATCH",
      credentials: "include",
      headers: {
  ...
  delete_notification: async ({ request, cookies }) => {
    ...
    const res = await fetch(`${BASE_API_URI}/notifications/delete-notification/${id}`, {
      method: "DELETE",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
  ...
  delete_all_notifications: async ({ cookies }) => {
    const res = await fetch(`${BASE_API_URI}/notifications/delete-all-notifications`, {
      method: "DELETE",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
