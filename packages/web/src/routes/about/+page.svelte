    ...
    <div class="flex flex-col items-center text-center">
      ...
      <div
        ...
        <div class="text-md text-justify">
          ...
          tristique metus lorem ut lectus. Maecenas lacinia sapien quis lacus
          consectetur, et molestie felis pulvinar. Vestibulum pharetra, quam sed
          sagittis pulvinar, mi quam finibus urna, id aliquam justo erat at
          nisi. Ut a ipsum ut massa porttitor varius. Duis vitae dui a massa
          aliquet tincidunt eu imperdiet turpis. Nam sodales felis at mauris
          ultrices, eget facilisis ante pharetra. Morbi lobortis, mi nec
          vulputate malesuada, lacus augue dapibus urna, quis scelerisque odio
          nisi vitae neque. Phasellus metus mi, elei
        </div>
      </div>
    </div>
    <div class="flex flex-col items-center text-center">
