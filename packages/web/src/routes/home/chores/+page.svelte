<script lang="ts">
    ...
    import { ReloadIcon, TagIcon, UserIcon, BedroomIcon, SearchIcon } from '$lib/utils/icons';
    ...
    <div class="flex flex-col gap-3">
        <div class="flex gap-2">
            ...
            <a class="flex flex-row flex-wrap gap-2" href="/home/chores/new">
                <button formaction="?/create_chore" class="btn btn-primary btn-sm w-[92px]"
                    >Add</button
                >
            </a>
        </div>
        <div class="flex flex-row gap-2 w-full justify-between">
            <div>
                <a href="/home/chores" data-sveltekit-reload>
                    <button class="btn shadow-sm btn-outline btn-sm rounded-md border-neutral-200">
